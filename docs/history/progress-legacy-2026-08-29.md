...
This is the complete pre-migration Progress snapshot from 2026-08-29. It preserves historical
Phase/Task/Fix/SHA/test/review evidence and must not be used as the current closure ledger or workflow
authority. The current ledger is [`docs/progress.md`](../progress.md); current workflow is
